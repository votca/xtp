...
#pragma omp critical
 ...
 template Eigen::MatrixXd RPA::calculate_epsilon<false>(double frequency)const;
    ...
    rpa_eigensolution RPA::diag_C(Eigen::VectorXd& AmB, Eigen::MatrixXd& C) const {
      ...
      // TODO: For methane, I get a very small negative eigenvalue. What to do with those?
      
      if (eigenvalues.minCoeff() < -1e-8) { // TODO: I could just take the first element in the array
        // TODO: Give warning here?
      }

      // TODO: For methane, I get a very small negative eigenvalue. What to do with those? Set it to zero?
