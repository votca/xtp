...
BSE::Population BSE::FragmentPopulations(const QMStateType& type,
  ...
  Eigen::VectorXd nuccharges =
      _orbitals.FragmentNuclearCharges(dftbasis.getAtomNumberFragbreak());
