...
BOOST_AUTO_TEST_CASE(single_bond){
    ...
    single_bondXYZ << "C          0.00000        0.00000        0.00000" << std::endl;
    single_bondXYZ << "C          1.00000        0.00000        0.00000" << std::endl;
...
BOOST_AUTO_TEST_CASE(single_angle){
    ...
    single_angleXYZ << "H          0.00000        0.00000        0.00000" << std::endl;
    single_angleXYZ << "O          1.00000        0.00000        0.00000" << std::endl;
    single_angleXYZ << "H          1.00000        1.00000        0.00000" << std::endl;
...
BOOST_AUTO_TEST_CASE(single_dihedral_two_angles_ic_test){
    ...
    single_dihedralXYZ << "H          0.00000        0.00000        0.00000" << std::endl;
    single_dihedralXYZ << "C          1.00000        0.00000        0.00000" << std::endl;
    single_dihedralXYZ << "C          1.00000        1.00000        0.00000" << std::endl;
    single_dihedralXYZ << "H          1.00000        1.00000        1.00000" << std::endl;
